...
from promptflow._sdk._constants import ConnectionProvider, LOGGER_NAME
from promptflow._sdk._logger_factory import LoggerFactory
from promptflow._sdk._utils import dump_yaml
from promptflow.exceptions import ValidationException, ErrorTarget
...
class Configuration(object):
    ...
    def _get_workspace_from_config(
        ...
        *,
        ...
        from azure.ai.ml.constants._common import RESOURCE_ID_FORMAT, AZUREML_RESOURCE_PROVIDER
